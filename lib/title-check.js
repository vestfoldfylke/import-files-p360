...
const getProbableTitle = (textLines, knownTitles, zipcodes) => {
  ...
  for (const line of firstLines) {
    ...
    // En liten ide til - fjern enkeltstående bokstaver og tall - sjekk om det resterende er langt nok til å gi mening, implementer om det tregns. Note - det vil fjerne f. eks "V I T N E M A L", men det kan også legges i known-titles
