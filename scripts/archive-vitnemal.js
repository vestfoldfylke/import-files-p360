(async () => {
  ...
  if (!VITNEMAL.FALLBACK_ORGANIZATION_NUMBER) throw new Error('VITNEMAL_FALLBACK_ORGANIZATION_NUMBER must be set')
  if (!VITNEMAL.FALLBACK_ACCESS_GROUP) throw new Error('VITNEMAL_FALLBACK_ACCESS_GROUP must be set')
